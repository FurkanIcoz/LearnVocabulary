...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LearnVocabulary.Models.UnknownWord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("EnglistText")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<bool>("HasLearned")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("LearnVocabulary.Models.WordsSentence", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("UnknownWordId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("UnknownWordId");

                    b.ToTable("WordsSentences");
                });
            ...
            modelBuilder.Entity("LearnVocabulary.Models.WordsSentence", b =>
                {
                    b.HasOne("LearnVocabulary.Models.UnknownWord", "UnknownWord")
                        .WithMany("WordsSentences")
                        .HasForeignKey("UnknownWordId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("UnknownWord");
                });
